...
<div class="shortcut-row"><kbd>Shift+휠</kbd><span>타임라인 스크롤</span></div>
  ...
  // 에디터 — 대형/타임라인
  { q: ['대형 추가', '대형 추가', '포메이션'], a: '타임라인의 빈 곳을 클릭한 뒤 "+ 대형" 버튼을 누르거나, N 키를 누르세요.', context: 'editor' },
  { q: ['대형 삭제', '대형 삭제'], a: '삭제할 대형을 선택한 뒤 "− 대형" 버튼 또는 Delete 키를 누르세요.', context: 'editor' },
  { q: ['복사', '붙여넣기', '대형 복사'], a: '대형을 선택하고 복사 버튼(Ctrl+C)을 누른 뒤, 빈 곳을 클릭하고 붙여넣기(Ctrl+V)하세요.', context: 'editor' },
  { q: ['프리셋', '대형 모음', '원형', 'V자'], a: '사이드바의 대형 모음에서 원형, V자 등 프리셋을 한 번에 적용할 수 있어요.', context: 'editor' },
  ...
  { q: ['경유점', 'waypoint', '동선', '곡선'], a: '두 대형 사이 동선 구간(화살표)을 클릭하면 경유점을 편집할 수 있어요. 댄서의 동선을 곡선으로 만들 수 있습니다.', context: 'editor' },
  ...
  { q: ['타임라인 사용법', '대형 박스'], a: '대형 박스를 드래그해서 이동/리사이즈, 대형 사이 화살표 클릭으로 동선 구간 선택, 동선 구간에서 경유점 편집이 가능해요.', context: 'editor' },
