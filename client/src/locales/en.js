export const en = {
  ...
  marketSelectHint: 'Select consecutive formations (max {max}). Click start and end.',
  marketSelectionCount: '{count} selected (max {max})',
  marketMaxFormations: 'You can select up to {max} formations',
  marketSelectEnd: 'Click the end formation',
  marketBadgeStart: 'Start',
  marketBadgeEnd: 'End',
  marketPresetTitle: 'Preset Name',
  marketPresetDesc: 'Description (optional)',
