export const en = {
  ...
  marketAudienceBottom: 'Audience ↓',
  marketAudienceTop: 'Audience ↑',
  marketTagFilterBtn: 'Tag filter',
  marketTagFilterApply: 'Apply',
  ...
  logoutConfirm: 'Sign out?\nCloud notes will be removed from this device but kept on the server. They will be restored when you sign back in.',
  cloudRestoreToast: 'Restored {count} notes from the cloud',
  sessionExpiredBanner: 'Your session expired. Sign in again to restore your cloud notes.',
  sessionExpiredDismiss: 'Dismiss',
  folderLocal: 'This device',
  folderCloud: 'Cloud',
  folderLocalEmpty: 'No notes on this device',
  folderCloudEmpty: 'No notes in the cloud. Use the ⋯ menu on a card to move it to the cloud',
  folderCloudLoginHint: 'Sign in to back up notes to the cloud',
  moveToCloud: '☁ Move to cloud',
  moveToLocal: '💻 Move to this device',
  confirmMoveToLocal: 'Moving back to this device also deletes the server copy. Continue?',
  moveToCloudSuccess: 'Moved to cloud',
